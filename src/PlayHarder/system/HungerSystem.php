...
class HungerSystem {
	const WALKING_AND_SNEAKING = 0.001;
	const SWIMMING = 0.001;
	const BREAKING_A_BLOCK = 0.001;
	const SPRINTING = 0.001;
	const JUMPING = 0.001;
	const ATTACKING_AN_ENEMY = 0.001;
	const RECEIVING_ANY_DAMAGE = 0.001;
	const JUMPING_WHILE_SPRINTING = 0.001;
